...
<?php
          // GET method is a default method
echo "<h1>Inserting data by using GET method</h1>";
echo "<h3>Here your data is not secure means your entered data is visible in url</h3>";
$rn=$_GET['rollno'];
$fn=$_GET['firstname'];
$ln=$_GET['lastname'];
$em=$_GET['email'];
$ps=$_GET['Password'];
$cp=$_GET['Confirm_password'];
